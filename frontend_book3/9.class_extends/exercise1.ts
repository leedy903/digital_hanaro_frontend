interface Array<T> {
    ...
    lastObject: T;
    mapBy: (prop: string) => T[];
    filterBy(prop: string, value: T, isIncludes?: boolean): T[];
    rejectBy(prop: string, value: number, isIncludes?: boolean): T[];
    findBy(prop: string, value: number): T[];
